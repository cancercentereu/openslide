...
// ICC v2 profile: linear sRGB (sRGB primaries, D50 PCS, gamma 1.0).
// Hamamatsu NDPI scanners output pixel data in linear light; attaching this
// profile lets a color-managed pipeline apply the sRGB transfer function.
static const uint8_t ndpi_linear_srgb_icc[] = {
  0x00, 0x00, 0x01, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x02, 0x10, 0x00, 0x00,
  ...
  ,
  ...
  0x58, 0x59, 0x5a, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6f, 0xa3,
  0x00, 0x00, 0x38, 0xf6, 0x00, 0x00, 0x03, 0x91, 0x58, 0x59, 0x5a, 0x20,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x62, 0x94, 0x00, 0x00, 0xb7, 0x85,
  0x00, 0x00, 0x18, 0xdc, 0x58, 0x59, 0x5a, 0x20, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x24, 0xa1, 0x00, 0x00, 0x0f, 0x85, 0x00, 0x00, 0xb6, 0xd4,
...
struct hamamatsu_jpeg_ops_data {
  ...
  // ICC profile for NDPI: points to either a heap copy of an embedded
  // profile (icc_profile_owned=true) or the static ndpi_linear_srgb_icc
  // array (icc_profile_owned=false).
  const void *icc_profile;
  int64_t icc_profile_size;
  bool icc_profile_owned;
...
static void jpeg_do_destroy(openslide_t *osr) {
  ...
  // ICC profile
  if (data->icc_profile_owned) {
    g_free((void *) data->icc_profile);
  }
...
static bool hamamatsu_read_icc_profile(openslide_t *osr, void *dest,
                                       GError **err) {
  struct hamamatsu_jpeg_ops_data *data = osr->data;
  if (!data->icc_profile || data->icc_profile_size == 0) {
    g_set_error(err, OPENSLIDE_ERROR, OPENSLIDE_ERROR_FAILED,
                "No ICC profile");
    return false;
  }
  if (data->icc_profile_size != osr->icc_profile_size) {
    g_set_error(err, OPENSLIDE_ERROR, OPENSLIDE_ERROR_FAILED,
                "ICC profile size changed");
    return false;
  }
  memcpy(dest, data->icc_profile, data->icc_profile_size);
  return true;
}

static const struct _openslide_ops hamamatsu_jpeg_ops = {
  .paint_region = jpeg_paint_region,
  .read_icc_profile = hamamatsu_read_icc_profile,
...
static bool hamamatsu_ndpi_open(openslide_t *osr, const char *filename,
  ...
  // init ops
  if (!init_jpeg_ops(osr, g_steal_pointer(&setup),
                     restart_marker_scan, err)) {
    return false;
  }

  // set up ICC profile for color management
  struct hamamatsu_jpeg_ops_data *data = osr->data;
  int64_t tl_icc_count =
    _openslide_tifflike_get_value_count(tl, 0, TIFFTAG_ICCPROFILE);
  if (tl_icc_count > 0) {
    // use embedded ICC profile from TIFF tag
    const void *tl_icc = _openslide_tifflike_get_buffer(tl, 0,
                                                        TIFFTAG_ICCPROFILE,
                                                        NULL);
    if (tl_icc) {
      data->icc_profile = g_memdup(tl_icc, tl_icc_count);
      data->icc_profile_size = tl_icc_count;
      data->icc_profile_owned = true;
    }
  }
  if (!data->icc_profile) {
    // no embedded profile; Hamamatsu NDPI pixel data is in linear light,
    // so provide a synthetic linear-sRGB profile to enable correct gamma
    // in a color-managed pipeline
    data->icc_profile = ndpi_linear_srgb_icc;
    data->icc_profile_size = sizeof(ndpi_linear_srgb_icc);
    data->icc_profile_owned = false;
  }
  osr->icc_profile_size = data->icc_profile_size;
